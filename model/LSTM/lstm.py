...
if __name__ == '__main__':
    ...
    csv_file_name = 'dataset/inttraffic.csv'
    df = pd.read_csv(csv_file_name, sep=',', header=0)
    df['Time'] = pd.to_datetime(df['Time'])
    data = {
        tf.contrib.timeseries.TrainEvalFeatures.TIMES: df.index,
        tf.contrib.timeseries.TrainEvalFeatures.VALUES: df['Inttraffic'],
    }
